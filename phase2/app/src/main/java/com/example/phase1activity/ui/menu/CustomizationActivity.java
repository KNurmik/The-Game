...
public class CustomizationActivity extends AbstractActivity {
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    // Functionality for user to set their nickname.
    setNicknameButton.setOnClickListener(
        new View.OnClickListener() {
          final String VALID_NICKNAME_MESSAGE = "New nickname set successfully.";
          final String INVALID_NICKNAME_MESSAGE =
              "Nicknames must be between 1-8 characters. No commas!";
